            ...
            <div className="flex flex-col gap-4">
              <div className="flex space-between gap-4 flex-col xl:flex-row">
                <iframe
                  ...
                  src="https://charts.mongodb.com/charts-project1-tuzcu/embed/charts?id=64805c35-4539-4d14-8d50-9807fe142564&maxDataAge=60&theme=light&autoRefresh=true"
                ></iframe>
                <iframe
                  className="bg-white border-none rounded-sm h-[320px] 2xl:flex-1"
              ...
              <div className="flex space-between gap-4 flex-col xl:flex-row">
                ...
                <iframe
                  className="bg-white border-none rounded-sm h-[480px] xl:flex-1"
                  src="https://charts.mongodb.com/charts-project1-tuzcu/embed/charts?id=64820078-7f2b-4fbe-8ee1-3368aaeeb163&maxDataAge=60&theme=light&autoRefresh=true"
                ></iframe>
              </div>
              {/* div for 3 charts in a row */}
              <div className="flex space-between gap-4 flex-col xl:flex-row">
                ...
                <iframe
                  className="bg-white border-none rounded-sm h-[480px] xl:flex-1"
                  src="https://charts.mongodb.com/charts-project1-tuzcu/embed/charts?id=64805db0-abe9-4522-8d84-1e7088a94264&maxDataAge=60&theme=light&autoRefresh=true"
                ></iframe>
                <iframe
                  className="bg-white border-none rounded-sm h-[480px] xl:flex-1"
                  src="https://charts.mongodb.com/charts-project1-tuzcu/embed/charts?id=64805e14-23c6-487f-873f-74915df1e607&maxDataAge=60&theme=light&autoRefresh=true"
                ></iframe>
              </div>
