...
export default function EventForm() {
  ...
  const postData = async (data) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_ADDRESS}/events/createEvent`,
        {
          method: "POST",
          headers: {
  ...
  async function handleSubmit(e) {
    ...
    if (location1.state.type === "Edit") {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_SERVER_ADDRESS}/events/editEvent`,
          requestOptions
        )
        if (response.ok) {
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  onChange={(event) => {
                    setEvenDuration(event.target.value)
                  }}
                  type="number"
                  name="first-name"
                  value={eventDuration}
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  <option value="Child Education and Enrichment">
                  ...
                  <option value="Government Assistance Programs">
                    Government Assistance Programs
                  </option>
                  <option value="Employment and Career Development">
