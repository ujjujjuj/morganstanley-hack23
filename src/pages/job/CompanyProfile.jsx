      ...
      <div className="flex overflow-y-auto overflow-x-hidden relative flex-col flex-1">
        ...
        <main>
          ...
          <div className="h-56 bg-slate-200">
            <img className="object-cover w-full h-full" src={CompanyBg} width="2560" height={440} alt="Company background" />
          </div>

          {/* Header */}
          <header className="pb-6 text-center border-b bg-slate-50 border-slate-200">
            <div className="px-4 w-full sm:px-6 lg:px-8">
              <div className="mx-auto max-w-3xl">
                {/* Avatar */}
                <div className="-mt-12 mb-2">
                  <div className="inline-flex -mt-1 -ml-1 sm:mb-0">
                ...
                <div className="mb-4">
                  <h2 className="mb-2 text-2xl font-bold text-slate-800">Revolut Ltd</h2>
                ...
                <div className="inline-flex flex-wrap justify-center space-x-4 sm:justify-start">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-sm font-medium whitespace-nowrap text-slate-500">London, UK</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-4 h-4 fill-current shrink-0 text-slate-400" viewBox="0 0 16 16">
                      <path d="M11 0c1.3 0 2.6.5 3.5 1.5 1 .9 1.5 2.2 1.5 3.5 0 1.3-.5 2.6-1.4 3.5l-1.2 1.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l1.1-1.2c.6-.5.9-1.3.9-2.1s-.3-1.6-.9-2.2C12 1.7 10 1.7 8.9 2.8L7.7 4c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4l1.2-1.1C8.4.5 9.7 0 11 0ZM8.3 12c.4-.4 1-.5 1.4-.1.4.4.4 1 0 1.4l-1.2 1.2C7.6 15.5 6.3 16 5 16c-1.3 0-2.6-.5-3.5-1.5C.5 13.6 0 12.3 0 11c0-1.3.5-2.6 1.5-3.5l1.1-1.2c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4L2.9 8.9c-.6.5-.9 1.3-.9 2.1s.3 1.6.9 2.2c1.1 1.1 3.1 1.1 4.2 0L8.3 12Zm1.1-6.8c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-4.2 4.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l4.2-4.2Z" />
                    </svg>
                    <a className="ml-2 text-sm font-medium text-indigo-500 whitespace-nowrap hover:text-indigo-600" href="#0">
                      revolut.com
                    </a>
                  </div>
                </div>
          ...
          <div className="px-4 py-8 w-full sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl">
              <h3 className="mb-6 text-xl font-bold leading-snug text-slate-800">Open Positions at Revolut Ltd</h3>

              {/* Job list */}
              <div className="space-y-6">
                {/* Group 1 */}
                <div>
                  <h4 className="mb-4 font-medium text-slate-800">Programming</h4>
                  {/* Job list */}
                ...
                {/* Group 2 */}
                <div>
                  <h4 className="mb-4 font-medium text-slate-800">Design</h4>
                  {/* Job list */}
                  <div className="space-y-2">
                    {items[1].map((item) => {
                      return (
                ...
                {/* Group 3 */}
                <div>
                  <h4 className="mb-4 font-medium text-slate-800">Management / Finance</h4>
                  {/* Job list */}
                  <div className="space-y-2">
                    {items[2].map((item) => {
                      return (
