            ...
            <div className="m-auto max-w-3xl">
              ...
              <div className="mb-6">
                <form className="relative">
                  ...
                  <input
                    id="action-search"
                    className="py-3 pl-9 w-full form-input focus:border-slate-300"
                    type="search"
                  />
                  <button
                  ...
                  >
                    <svg
                      className="mr-2 ml-3 w-4 h-4 fill-current shrink-0 text-slate-400 group-hover:text-slate-500"
                      viewBox="0 0 16 16"
              ...
              <div className="mb-8 border-b border-slate-200">
                <ul className="flex overflow-x-scroll flex-nowrap -mx-4 text-sm font-medium sm:-mx-6 lg:-mx-8 no-scrollbar">
                  ...
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a
                      className="whitespace-nowrap text-slate-500 hover:text-slate-600"
                      href="#0"
                    >
                      Accessibility
                    </a>
